    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Choisissez votre niveau pour explorer les cours de mathématiques
        </p>
      </div>
        ...
        {loading ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {levels.map((level) => {
              ...
              return (
                <Link key={level.code} href={`/student/catalog/${level.code}`}>
      ...
      <section className="mt-12 rounded-xl border bg-gradient-to-br from-primary/5 via-background to-primary/5 p-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold">L&apos;intégralité du programme de mathématiques</h2>
            <p className="text-muted-foreground text-sm mt-1">
              Tous les chapitres du programme officiel — fiches, exercices, vidéos et quiz dans chaque chapitre.
            </p>
          </div>
        </div>
      </section>
