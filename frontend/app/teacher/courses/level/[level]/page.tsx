...
export default function TeacherLevelCoursesPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-gradient-to-r from-primary/10 via-primary/5 to-background border p-6">
        <div className="flex items-end gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">Mes cours — {LEVEL_LABELS[level] ?? level}</h1>
              ...
              >
                <div className="h-28 bg-gradient-to-br from-blue-500 to-indigo-600 relative">
                  ...
                  {course.is_active === false && (
                    <div className="absolute top-2 right-2 rounded-full bg-yellow-500 text-white text-[10px] font-semibold px-2 py-0.5">
                      Inactif
                    </div>
                  )}
                </div>
